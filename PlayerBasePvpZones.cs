...
namespace Oxide.Plugins
{
  ...
  public class PlayerBasePvpZones : RustPlugin
  {
    ...
    private IEnumerator CreateDataForEnabledPlayers()
    {
      var startTime = DateTime.UtcNow;

      Puts("CreateDataForEnabledPlayers(): Starting zone creation for enabled players...");
      ...
      Puts($"CreateDataForEnabledPlayers():  Created {_buildingData.Count} building zones...");
      ...
      Puts($"CreateDataForEnabledPlayers():  Created {_shelterData.Count} shelter zones...");
      ...
      Puts($"CreateDataForEnabledPlayers():  Created {_tugboatData.Count} tugboat zones...");

      Puts($"CreateDataForEnabledPlayers(): ...Startup completed in {(DateTime.UtcNow - startTime).TotalSeconds} seconds.");
    ...
    private void OnServerInitialized()
    {
      ...
      NextTick(() =>
      {
        _createDataCoroutine = ServerMgr.Instance.StartCoroutine(CreateDataForEnabledPlayers());
      });
    }
